                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="<?= base_url('login/rubah')?>" method="post">
                                <?php foreach ($data as $y) { ?>
                                    <input type="hidden" name="email" value="$y['email']">
                               <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="repass" placeholder="Masukkan Ulang Password">
                                    <small><?php echo form_error('pass'); ?></small>
                                </div>
